...
from Step2_Model_Pretrain.utility_config_CheXclusion_uDense import utility_args, Setttings
from src.network.densenet_utility import DenseNet121
from src.loss.classification import BCEwithClassWeights
from src.helpers import utils
from src.helpers.datasets import MIMIC
...
if __name__ == '__main__':
    ...
    general.add_argument('-start_epoch', '--start_epoch', type=int, default=0, help="The start epochs for continue training")
    # Warmstart training
    ...
    args.vis_info = args.vis_info+' '+args.model
