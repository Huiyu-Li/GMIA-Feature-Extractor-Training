'''
Identity Classification trained on Anonymized data
'''
import os
import logging
import time
...
from Step2_Model_Pretrain.identityA_config import identity_args, Setttings
from src.helpers import utils
from src.network.iresnet import iresnet50, iresnet100
from src.helpers.datasets_identity1 import get_dataloader # to open X_A.jpg
...
from src.helpers.utils_distributed_callbacks1 import CallBackVerification # to open X_A.jpg
...
if __name__ == "__main__":
    ...
    # OMP_NUM_THREADS=8 torchrun --nproc_per_node=2 --nnodes=1 ./Step2_Model_Pretrain/identity_classification1.py
    # Debug: torchrun --standalone --nnodes=1 --nproc_per_node=1 ./Step2_Model_Pretrain/identity_classification1.py
