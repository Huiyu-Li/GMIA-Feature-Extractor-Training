...
class utility_args(object):
    ...
    Shared config
    """
    name = "Step2: Utility Classification Pre-training ChecXclusion uDense 14" # Debug
    ...
    # Optimizer params
    optim_type = 'adamw' #['adam', 'adamw']
    learning_rate = 3e-5#0.0005 # [1e-4(default: 1e-3), 3e-5(default: 1e-3)]
