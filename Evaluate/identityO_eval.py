'''
Identity evaluation for Outer Risk:
Whether or not a real image and its anonymized one belong to the same patient
'''
import os
import logging
...
from Step4_Evaluate.identityO_eval_config import identity_args, Setttings
from src.helpers import utils
from src.network.iresnet import iresnet50, iresnet100
from src.helpers.datasets_identity import MIMICO # For R_A pairs
...
def main():
    ...
    testSet = MIMICO(csv_path = args.csv_path,
                    image_root=args.image_root,
                    anony_root=args.anony_root,
