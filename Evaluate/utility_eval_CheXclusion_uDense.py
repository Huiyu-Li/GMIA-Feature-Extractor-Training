...
from Step4_Evaluate.utility_eval_config_CheXclusion_uDense import utility_args, Setttings
from src.network.densenet_utility import DenseNet121
...
def test(args, test_loader, model, device, logger):
    ...
    # metrics
    # preds_tensor = preds_tensor[:,:3]
    # target_tensor = target_tensor[:,:3]
    print(preds_tensor.shape, target_tensor.shape)
    criteria = {
