'''
Identity evaluation for Inner Risk:
Whether or not two anonymized image belong to the same patient
'''
import os
import logging
...
from Step4_Evaluate.identityI_eval_config import identity_args, Setttings
from src.helpers import utils
from src.network.iresnet import iresnet50, iresnet100
from src.helpers.datasets_identity import MIMICI # to open X_A.jpg
...
def main():
    ...
    testSet = MIMICI(csv_path = args.csv_path,
